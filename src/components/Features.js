  ...
  const features = [
    {
      ...
      icon: "/images/icon 1.png", // Replace with your image paths
    },
    {
      title: "Measure Real Impact",
      description: "See how each change affects your bottom line",
      icon: "/images/icon 2.png", // Replace with your image paths
    },
    {
      title: "Achieve Your Goals",
      description: "Set targets and watch your progress in real-time",
      icon: "/images/icon 3.png", // Replace with your image paths
    },
  ];
